...
[![Version](https://img.shields.io/badge/version-4.2.5-blue)](https://github.com/sunnys-santhosh/deep-vault/releases)
...
### v4.2.5
- 🔧 Removed the stray `console.log("Deep Vault v3.1.2 loaded ✅")` debug statement from `onload()` — also fixes the version string having gone stale since v3.1.2
...
### v4.2.2
- 🐛 Fixed `deploy.bat` requiring the vault path to be hardcoded and manually edited — it now takes the vault path as a command-line argument, matching `build.sh` and `npm run deploy -- <path>`
